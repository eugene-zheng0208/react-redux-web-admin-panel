...
namespace Akvelon.TestTask.Server
{
    /// <summary>
    ...
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c => { c.SwaggerDoc("v1", new Info { Title = "Akvelon Test Task API", Version = "v1" }); });
            services.AddSwaggerGen(c =>
            {
                var basePath = PlatformServices.Default.Application.ApplicationBasePath;
                var xmlPath = Path.Combine(basePath, "Akvelon.TestTask.Server.xml");
            ...
            var config = new AutoMapper.MapperConfiguration(cfg =>
            {
                ...
                cfg.AddProfile(new ProductCategoriesProfile());
                cfg.AddProfile(new ProductSubCategoriesProfile());
            });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "Akvelon Test Task API"); });
        }
    }
}
